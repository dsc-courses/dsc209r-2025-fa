...
2. Submit maximum 1-minute video to Canvas in `mp4` format. The video should include:
...
**Videos longer than 1 minute will be trimmed to 1 minute before we grade, so make sure your video is 1 minute or less.**
